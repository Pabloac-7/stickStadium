...
public class PlayerController : MonoBehaviour{
    ...
    void Start(){
        ...
        if(PlayerPrefs.HasKey("leftP1"))
            left = (KeyCode)System.Enum.Parse(typeof(KeyCode), PlayerPrefs.GetString("leftP1"));
        if(PlayerPrefs.HasKey("rightP1"))
            right = (KeyCode)System.Enum.Parse(typeof(KeyCode), PlayerPrefs.GetString("rightP1"));
        if(PlayerPrefs.HasKey("jumpP1"))
            jump = (KeyCode)System.Enum.Parse(typeof(KeyCode), PlayerPrefs.GetString("jumpP1"));
        if(PlayerPrefs.HasKey("punchP1"))
            punch = (KeyCode)System.Enum.Parse(typeof(KeyCode), PlayerPrefs.GetString("punchP1"));
        if(PlayerPrefs.HasKey("kickP1"))
            kick = (KeyCode)System.Enum.Parse(typeof(KeyCode), PlayerPrefs.GetString("kickP1"));
        if(PlayerPrefs.HasKey("blockP1"))
            block = (KeyCode)System.Enum.Parse(typeof(KeyCode), PlayerPrefs.GetString("blockP1"));
